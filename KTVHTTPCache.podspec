Pod::Spec.new do |s|
  ...
  s.homepage            = "https://github.com/ryancw/KTVHTTPCache"
  s.license             = { :type => "MIT", :file => "LICENSE" }
  s.author              = { "Single" => "libobjc@gmail.com" }
  s.social_media_url    = "https://weibo.com/3118550737"
  s.platform            = :tvos, "9.0"
  s.source              = { :git => "https://github.com/ryancw/KTVHTTPCache.git", :tag => "#{s.version}" }
  ...
  s.requires_arc        = true
  s.dependency 'KTVCocoaHTTPServer', '~> 1.0.0'
end
